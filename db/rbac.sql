...
-- 1) Normalizacija: tekst kolone u users imaju default '', a aplikacija
--    tretira null kao kanonsko "prazno" ("na čekanju" za role)
alter table public.users alter column role drop default;
alter table public.users alter column full_name drop default;

update public.users set role = null where role = '';
